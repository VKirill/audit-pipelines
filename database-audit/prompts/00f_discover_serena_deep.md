...
**ОБЯЗАТЕЛЬНО** (это главный класс находок этого пайплайна):
...
PII колонки выходят за рамки базового списка. Дополнительно ищи через Serena:
...
## 🔴 Idempotency unique-constraint verification
