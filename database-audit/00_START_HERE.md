...
**Это точка входа в Database Audit Pipeline v2. Архитектура — manifest-driven.**
...
ИИ-модель выполнит **16-шаговый протокол** из `prompts/00_discover.md` и создаст `database-audit.manifest.yml`. Это занимает ~20-40 минут на средний проект.
