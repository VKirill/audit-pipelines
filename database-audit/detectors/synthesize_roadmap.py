...
def main():
    ...
    (audit_dir / '10_synthesis.md').write_text(
        f'# Phase 10 — Synthesis\n\nGenerated by synthesize_roadmap detector.\n\n'
        f'See ROADMAP.md for the prioritized output.\n\n'
        f'Findings count: {len(findings)}\n'
        f'Severity distribution: {dict(sev)}\n'
    )
...
# (patch) Also emit audit/10_synthesis.md report file
