...
Перед всеми smells — составь список и прочитай тела. Это **требование v2**: без ручного чтения ты не имеешь права писать `confidence: high` про качество кода.
